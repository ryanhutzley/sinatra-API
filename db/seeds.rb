...
Activity.create(name: "Pilates", img_url: "https://images01.military.com/sites/default/files/styles/full/public/media/military-fitness/2015/03/pilatesbanner.jpg", description: "Pilates makes the world go round", morning: false, afternoon: true, evening: false, short_workout: false, medium_workout: true, long_workout: false, music: true, cardio: true, strength: true, small_class_size: false, medium_class_size: true, large_class_size:false)
...
Activity.create(name: "Personal Sauna", img_url: "https://www.familypoolfun.com/images/saunas/perfect_heat/ph2402.jpg", description: "We have personal sauna boxes for your enjoyment!", morning: true, afternoon: true, evening: true, short_workout: true, medium_workout: true, long_workout: true, music: false, cardio: true, strength: false, small_class_size: true, medium_class_size: false, large_class_size:false )

Activity.create(name: "TRX", img_url: "https://classpass-res.cloudinary.com/image/upload/q_auto,f_auto/yhihjbqggbrgugoxnvp9.jpg", description: "Hang around on our TRX bands", morning: true, afternoon: true, evening: false, short_workout: true, medium_workout: true, long_workout: false, music: true, cardio: true, strength: true, small_class_size: false, medium_class_size: true, large_class_size:true )
...
50.times do
Booking.create(user_id: User.ids.sample, activity_id: Activity.ids.sample, day_of_week: ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday"].sample)
end