...
Activity.create(name: "Zumba", img_url: "https://thecentercville.org/event_images/zumba.jpg", description: "Zumba is a fitness program that combines Latin and international music with dance moves. Zumba routines incorporate interval training — alternating fast and slow rhythms — to help improve cardiovascular fitness.", start_time: "6am", duration: 90)
Activity.create(name: "Powerlifting", img_url: "https://thecentercville.org/event_images/zumba.jpg", description: "Zumba is a fitness program that combines Latin and international music with dance moves. Zumba routines incorporate interval training — alternating fast and slow rhythms — to help improve cardiovascular fitness.", start_time: "12pm", duration: 60)
Activity.create(name: "Crossfit", img_url: "https://joinfcf.com/wp-content/uploads/2017/08/Zumba.jpg", description: "Zumba is a fitness program that combines Latin and international music with dance moves. Zumba routines incorporate interval training — alternating fast and slow rhythms — to help improve cardiovascular fitness.", start_time: "10am", duration: 30)
Activity.create(name: "Yoga", img_url: "https://images-na.ssl-images-amazon.com/images/I/41663d8%2BNiL.png", description: "Zumba is a fitness program that combines Latin and international music with dance moves. Zumba routines incorporate interval training — alternating fast and slow rhythms — to help improve cardiovascular fitness.", start_time: "5pm", duration: 60)
